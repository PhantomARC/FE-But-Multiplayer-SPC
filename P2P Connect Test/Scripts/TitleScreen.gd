...
func _ready():
	...
	$CanvasLayer/containerScreen/vboxContainer/buttonPlay.connect("pressed",self,"_on_buttonPlay_pressed")
	$CanvasLayer/containerScreen/vboxContainer/buttonLobby.connect("pressed",self,"_on_buttonLobby_pressed")
